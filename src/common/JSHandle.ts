...
export interface Offset {
  /**
   * x-offset for the clickable point relative to the border box.
   */
  x: number;
  /**
   * y-offset for the clickable point relative to the border box.
   */
  y: number;
}
...
export interface ClickOptions {
  ...
  clickCount?: number;
  /**
   * Offset for the clickable point relative to the border box.
   */
  offset?: Offset;
}
